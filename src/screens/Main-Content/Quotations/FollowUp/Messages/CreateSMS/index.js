      ...
      .then(res => {
        ...
        if (data.code === 200) {
          ...
          if (response.code === 200) {
            ...
            props.navigation.navigate('Message', { customer: props.route.params.customer, customerData: props.route.params.customerData })
          }
          else {
  ...
  return (
    <KeyboardAvoidingView enabled keyboardVerticalOffset={100} behavior={Platform.OS == "ios" ? "padding" : "height"}>
      <ScrollView style={{ position: 'relative', height: '100%' }}>
        <View style={{ marginBottom: "17%" }}>
          ...
          <Dropdown
            ...
            value={selectedPhone}
            label="Phone Number"
            onChangeText={(value) => { setSelectedPhone(value) }}
            data={customerPhone}
          />
          ...
          <TextInput
            ...
            onChangeText={(text) => { if (charCount < 450) { setCharCount(text.length), setMessage(text) } }}
            value={message}
          />
      ...
      <View style={{ position: 'absolute', bottom: '0%', left: '0%', width: '100%' }}>
        <TouchableOpacity onPress={() => { selectedPhone && message && sendSMS() }} style={selectedPhone && message ? styles.buttonCon : styles.buttonCon2}>
