...
const VehicleDetailForm2 = (props) => {
  const onNext = () => {
    props.navigation.navigate('ObservationForm')
  }

  return (
    <View style={styles.page}>
      <Text style={{ textAlign: 'center', marginTop: '5%' }}>Vehicles Details Form - II</Text>
...
export default VehicleDetailForm2;